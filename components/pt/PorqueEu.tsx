...
export default function TrabalharComigo() {
  ...
  return (
    ...
    >
      <div className="w-full flex flex-col py-[80px] px-[30px]">
        <h2 className="text-[24px] md:text-[26px] text-white lg:text-[30px] pb-[60px] font-bold">
          Razões para trabalhar comigo
        </h2>
        ...
        <div className="flex flex-wrap gap-10 text-white my-10 text-3xl font-bold justify-between">
          <div className="mx-auto">
            ...
            <p className="text-[16px] sm:text-[18px] md:text-[20px] lg:text-[24px] max-w-[200px] text-[#777777] font-light">
              Lojas com sistemas em produção.
            </p>
          </div>
          ...
          <div className="mx-auto">
            ...
            <p className="text-[16px] sm:text-[18px] md:text-[20px] lg:text-[24px] max-w-[200px] text-[#777777] font-light">
              Dispositivos físicos e hardware integrados.
            </p>
          </div>
          ...
          <div className="mx-auto">
            ...
            <p className="text-[16px] sm:text-[18px] md:text-[20px] lg:text-[24px] max-w-[200px] text-[#777777] font-light">
              Operação confiável offline e em tempo real.
            </p>
          </div>
          ...
          <div className="mx-auto">
            ...
            <p className="text-[16px] sm:text-[18px] md:text-[20px] lg:text-[24px] max-w-[200px] text-[#777777] font-light">
              Projetos pensados para escalar desde o início.
            </p>
          </div>
        </div>
      </div>
